fn main() {
    ...
    println!("cargo:rerun-if-changed=imports/dyn_plugin_add/build/abi.json");

    println!("cargo:rerun-if-changed=imports/dyn_plugin_mul/build/abi.json");

    println!("cargo:rerun-if-changed=imports/dyn_token_plugin/build/abi.json");
