fn main() {
    ...
    println!("cargo:rerun-if-changed=imports/dyn_plugin_add/build/dyn_plugin_add/abi.json");

    println!("cargo:rerun-if-changed=imports/dyn_plugin_mul/build/dyn_plugin_mul/abi.json");

    println!("cargo:rerun-if-changed=imports/dyn_token_plugin/build/dyn_token_plugin/abi.json");
